    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted">
                                        <?php echo date('d M Y, h:i A', strtotime($gatepass['admin_approved_at'])); ?>
                                    </small>
                                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small class="text-muted">
                                        <?php echo date('d M Y, h:i A', strtotime($gatepass['security_approved_at'])); ?>
                                    </small>
                                    <?php else: ?>
                                    <span class="text-warning">Pending</span>
                                    <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td class="text-danger">
                                    ...
                                    <br>
                                    <small class="text-muted">
                                        <?php echo date('d M Y, h:i A', strtotime($gatepass['declined_at'])); ?>
                                    </small>
                                </td>
                            </tr>
                            <tr>
                ...
                <h6 class="fw-bold mt-4">Items</h6>                <div class="table-responsive">
                                ...
                                <td>
                                    <?php if (!empty($item['is_returnable']) && $item['is_returnable'] == 1): ?>
                                        ...
                                        <?php if (!empty($item['returned']) && $item['returned'] == 1): ?>
                                            ...
                                            <br><small class="text-muted"><?php echo date('d M Y', strtotime($item['return_date'])); ?></small>
                                        <?php endif; ?>
                                    <?php else: ?>
