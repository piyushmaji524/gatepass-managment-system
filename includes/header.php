...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?><?php echo APP_NAME; ?></title>    <!-- Favicon -->
    <?php 
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">                    <?php 
                    ...
                    if ($_SESSION['role'] == 'admin'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($current_page == 'download_pdf.php') ? 'active' : ''; ?>" href="download_pdf.php">
                                <i class="fas fa-file-pdf me-1"></i> Download Gatepass
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link <?php echo ($current_page == 'pending_returns.php') ? 'active' : ''; ?>" href="pending_returns.php">
                                <i class="fas fa-exchange-alt me-1"></i> Pending Returns
                            </a>
                        </li>
                        <li class="nav-item">
