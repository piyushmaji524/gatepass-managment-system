...
// Count pending returnable items
$stmt = $conn->prepare("
    SELECT COUNT(*) AS returnable_count 
...
");
$stmt->execute();
$pending_returns_count = $stmt->get_result()->fetch_assoc()['returnable_count'];
                                    ...
                                    <?php while ($gatepass = $recent_gatepasses->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td><?php echo formatDateTime($gatepass['created_at'], 'd M Y'); ?></td>                                            <td>
                                                <a href="view_gatepass.php?id=<?php echo $gatepass['id']; ?>" class="btn btn-sm btn-primary me-1" title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="verify_gatepass.php?id=<?php echo $gatepass['id']; ?>&direct_verify=1" class="btn btn-sm btn-success" title="Verify Immediately" onclick="return confirm('Are you sure you want to verify this gatepass?');">
            ...
            <div class="card text-white bg-warning h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0"><?php echo $pending_returns_count; ?></h3>
                    </div>
                </div>
                <div class="card-footer bg-transparent border-0">
                    <a href="pending_returns.php" class="text-white">View all <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card text-white bg-success h-100">
                ...
                <div class="card-footer bg-transparent border-0">
                    <a href="search_gatepass.php?status=approved_by_security" class="text-white">View all <i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="search_gatepass.php" class="btn btn-lg btn-outline-primary">
                            <i class="fas fa-search me-2"></i>Search Gatepass
                        </a>
                        <a href="verified_gatepasses.php" class="btn btn-lg btn-outline-success">
